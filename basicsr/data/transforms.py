...
def single_random_crop(img_gts, gt_patch_size, gt_path=None):
...
if __name__ == '__main__':
    ...
    img_gts = []
    for i in range(5):
        # img_gts.append(np.zeros((h, w, c)))
        img_gts.append(torch.rand(1, c, h, w))
    img_gts = single_random_crop(img_gts, gt_patch_size=512)
    print(len(img_gts))